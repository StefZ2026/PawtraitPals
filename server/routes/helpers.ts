...
// --- Typed auth helpers (replaces (req as any).user.claims.sub) ---
...
export function getUserEmail(req: Request): string {
  return (req as any).user.claims.email as string;
}
...
export async function getOrgForUser(req: Request, orgIdParam?: number | null): Promise<any> {
