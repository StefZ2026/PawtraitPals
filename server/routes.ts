...
export async function registerRoutes(
  ...
  // --- Pet Import from External Platforms (Petfinder, RescueGroups, ShelterLuv) ---
  ...
  app.get("/api/import/animals", isAuthenticated, async (req: any, res: Response) => {
    try {
      const providerName = req.query.provider as string;
  ...
  app.post("/api/import/pets", isAuthenticated, async (req: any, res: Response) => {
    try {
