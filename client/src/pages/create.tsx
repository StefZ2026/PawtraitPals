...
export default function Create() {
  ...
  const generateMutation = useMutation({
    mutationFn: async () => {
      ...
      const prompt = `Transform the provided photo of this ${breed} ${speciesLabel} named "${safeName}" into the following artistic style. CRITICALLY IMPORTANT: The ${speciesLabel}'s EXACT fur/coat color from the photo must be preserved — do not shift, lighten, darken, or change the hue in any way. Keep all of the ${speciesLabel}'s actual appearance, markings, and features recognizable.${realismNote} Style: ${selectedStyle!.promptTemplate.replace("{breed}", breed)}`;
