      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <p className="text-center text-sm text-muted-foreground" data-testid="text-custom-pricing">
            Need more pets? <a href="mailto:support@pawtraitpals.com" className="underline hover-elevate" data-testid="link-contact-pricing">Contact us</a> for custom pricing.
          </p>
      ...
      <AlertDialog open={showSkipDialog} onOpenChange={setShowSkipDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {hasUsedFreeTrial
                ? "We'd love to help your rescue pets find their forever homes. When you're ready, come back and choose a plan that fits your rescue."
                : "We'd love to help your rescue pets find their forever homes. Whenever you're ready, come back and give Pawtrait Pals a try — your free trial will be waiting for you."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
