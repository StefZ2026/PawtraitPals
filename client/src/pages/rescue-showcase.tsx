          ...
          >
           <div className="showcase-inner">
            ...
            <div className="border-t-2 border-primary/15 py-4 pb-6 px-6 flex flex-col items-center justify-center gap-3">
              ...
              <span className="flex items-center gap-1.5 font-serif font-bold text-xl text-primary"><span className="flex items-center gap-0.5"><Dog className="h-4 w-4" /><Cat className="h-4 w-4" /></span>Pawtrait Pals</span>
            </div>
           </div>
          </div>
