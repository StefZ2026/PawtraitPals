                    ...
                    <tbody>
                      {pastDueOrgs.map((org) => (
                        <tr key={org.id} className="border-b last:border-0" data-testid={`row-pastdue-${org.id}`}>
                          ...
                          <td className="py-3">
                            {org.contactEmail && (
                              <a href={`mailto:${org.contactEmail}?subject=Pawtrait Pals - Payment Past Due&body=Hi,%0A%0AWe noticed your Pawtrait Pals subscription payment is past due. Please update your payment method to continue using the service.%0A%0AThank you,%0APawtrait Pals Team`}>
    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8 flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Pawtrait Pals Admin</h1>
