        ...
        <div className="prose prose-stone dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using Pawtrait Pals ("the Service") at pawtraitpals.com, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Service. These Terms apply to all users, including rescue organizations, administrators, and visitors.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              Pawtrait Pals offers subscription plans with varying features and limits. By subscribing to a paid plan, you agree to pay the applicable fees as described at the time of purchase.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              You retain ownership of all content you upload to the Service, including pet photos, organization logos, descriptions, and other materials ("User Content"). By uploading User Content, you grant Pawtrait Pals a non-exclusive, worldwide license to use, display, and process that content for the purpose of providing the Service, including:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
