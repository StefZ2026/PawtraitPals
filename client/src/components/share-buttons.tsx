...
export function ShareButtons({ url, title, text, dogId, dogName, dogBreed, orgId, portraitImageUrl, adoptionUrl, orgWebsiteUrl, captureRef, showcaseName }: ShareButtonsProps) {
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-2">
            <p className="text-xs text-muted-foreground leading-relaxed">
              By providing your phone number and clicking the checkbox below you agree to receive SMS notifications from Pawtrait Pals. Message frequency may vary. Standard Message and Data Rates may apply. Reply STOP to opt out. Reply HELP for help. We will not share mobile information with third parties for promotional or marketing purposes.
            </p>
